...
def test_one_epoch(model, dataloader, device, reg_loss_func, use_amp=False, linear_correction=True):
...
def parse_args():
    ...
    default_output_dir = os.path.join(current_dir, '../../train_model/Topt/savetrain/toptreg2040')
