...
def parse_args():
    ...
    default_csv = os.path.join(current_dir, '../../data/Topt/topt_rest.csv')
...
def main():
    ...
    model = Mymodel_toptreg2(vocab_size=vocab_size).to(device)
    ...
    model, optimizer, scheduler, progress, paths = prepare_training_independent(
        args.save_dir, model_name="toptreg120", build_model_fn=lambda: model,
