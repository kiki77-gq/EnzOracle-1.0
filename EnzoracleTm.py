...
from Tm.modelTm import FinalModel



def parse_args():
    parser = argparse.ArgumentParser(description="Tm Prediction Tool for User Sequences")
    ...
    parser.add_argument('--db_path', type=str, 
                        default=os.path.join(current_dir, 'data/Tm/Tm.csv'), 
...
def main():
    ...
    if os.path.exists(args.db_path):
        ...
        db_dict = dict(zip(db_df[seq_col], db_df['tm']))
